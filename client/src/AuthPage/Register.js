...
import { passwordConfValidationMessage, usernameValidationMessage, validatePasswordConf, validateUsername } from '../shared/validators';
      ...
      const handleInputValidationOnBlur = (value, field) =>{
        ...
        switch (field){
            ...
            case 'username':
                ...
                break;
            case 'passwordConf':
                isValid= validatePasswordConf(formState.password.value, validateEmail);
                break;
            default:
                break;
        }
